...
> **注**：实际执行中 phase 编号与本文档初始规划有偏差。规划中 Phase 6="Window/Application/Event+BackendPlugin"、Phase 7="SFML 后端"、Phase 8="raylib 后端"。额外完成的 Phase 7-12 为本文档编写时未预见的工作项（实际去耦步骤），见 §10-§14a。当前 Phase 6 已完成（§7），规划中的 SFML/raylib 后端推迟为 Phase 13/14。
