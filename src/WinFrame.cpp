    ...
    m_cursorSizeNESW(Cursor::createSystem(SystemCursorType::NESW_Resize))
{
    ...
    addControl(m_closeButton = ButtonBuilder(this,
        ...
        .setNormalStateActor(    make_shared<Actor>(this, string("assets/images/cross_up.png"), true))
        .setHoverStateActor(     make_shared<Actor>(this, string("assets/images/cross_over.png"), true))
        .setPressedStateActor(   make_shared<Actor>(this, string("assets/images/cross_down.png"), true))
